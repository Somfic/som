use crate::tests::test_helpers::{interpret_strict, expect_error};
...
fn test_closure_no_capture_when_not_needed() {
    ...
    assert_eq!(99, interpret_strict("let x = 10; let f = fn() -> int { 99 }; f()"));
}
